    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section">
          <h4>About Us</h4>
          <ul>
            <li><a href="#about">About Revvit</a></li>
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            {/* <li><a href="#vulnerability">Vulnerability Disclosure</a></li> */}
          </ul>
        </div>
          ...
          <div className="footer-apps">
            ...
            <div className="app-links">
              <a href="#google-play" className="app-link">
                <img src={img} alt="Get it on Google Play" />
              </a>
              <a href="#app-store" className="app-link">
                <img src={img} alt="Download on the App Store" />
              </a>
            </div>
          </div>
          
          <div className="footer-copyright">
            <p>&copy; 2025 Revvit. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
